...
const compounds = [
  ...
  },
  {
    ...
    desc: "NAD+ (Nicotinamide Adenine Dinucleotide) is a critical coenzyme found in all living cells. Research focuses on its role in cellular energy metabolism, DNA repair, sirtuin activation, mitochondrial biogenesis, and age-related metabolic decline. Widely studied in longevity and metabolic disease models."
  },
  {
    name: "Semaglutide",
    cat: "Metabolic Research",
    ...
    packPrice: 1340000,
    packSize: 10,
    imgs: ["images/samaglutide-1.jpeg"],
    desc: "Semaglutide is a GLP-1 receptor agonist (Ozempic/Wegovy). Research demonstrates potent effects on glucose-dependent insulin secretion, appetite suppression, gastric emptying modulation, and significant body weight reduction. Extensively studied in type 2 diabetes and obesity research models."
  }
];
